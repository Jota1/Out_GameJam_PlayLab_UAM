...
public class PoolHandler : MonoBehaviour
{
    ...
    public static PoolHandler Instance
    {
        get
        {
            if(instance == null)
            {
                instance = FindObjectOfType<PoolHandler>();
                if(instance == null)
                {
                    var obj = new GameObject("PoolHandler");
                    instance = obj.AddComponent<PoolHandler>();
    ...
    public class PoolData
    {
        ...
        {
            if (bank == null) Debug.Log(key + " has no bank!");
